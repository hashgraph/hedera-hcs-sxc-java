...
public final class Utils {
    ...
    public static String PrettyStatus(Enums.state status) {
        switch (status) {
            case CREDIT_PROPOSED_PENDING:
                return "Pending";
            ...
            case SETTLEMENT_PROPOSED_PENDING:
                return "Pending";
            ...
            case PAYMENT_INIT_ACK:
                return "Unknown";
            case PAYMENT_INIT_AWAIT_ACK:
                return "Unknown";
            case PAYMENT_INIT_PENDING:
                return "Unknown";
            case PAYMENT_SENT_ACK:
                return "Unknown";
            case PAYMENT_SENT_AWAIT_ACK:
                return "Unknown";
            case PAYMENT_SENT_PENDING:
                return "Unknown";
            case SETTLE_COMPLETE_ACK:
                return "Unknown";
            case SETTLE_COMPLETE_AWAIT_ACK:
                return "Unknown";
            case SETTLE_COMPLETE_PENDING:
                return "Unknown";
            case SETTLE_INIT_ACK:
                return "Unknown";
            case SETTLE_INIT_AWAIT_ACK:
                return "Unknown";
            case SETTLE_INIT_PENDING:
                return "Unknown";
            case SETTLE_PAID_ACK:
                return "Unknown";
            case SETTLE_PAID_AWAIT_ACK:
                return "Unknown";
            case SETTLE_PAID_PENDING:
                return "Unknown";
            default:
                return "Unknown";
        }
