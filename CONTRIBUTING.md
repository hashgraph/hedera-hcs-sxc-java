...
The Hedera HCS SXC project accepts contributions via GitHub pull requests. This document outlines the
...
[GitHub issues](https://github.com/hashgraph/hedera-hcs-sxc/issues). However, if
...
There are 3 types of issues (each with their own corresponding [label](https://github.com/hashgraph/hedera-hcs-sxc/labels)):
...
1. Fork the [hedera-hcs-sxc](https://github.com/hashgraph/hedera-hcs-sxc) repo

Go to the [project](https://github.com/hashgraph/hedera-hcs-sxc) page then hit the `Fork`
...
```sh
$ git clone https://github.com/$your_github_account/hedera-hcs-sxc.git   
```
3. Add an `upstream` remote to keep your fork in sync with the main repo.
```sh
$ cd hedera-hcs-sxc
$ git remote add upstream https://github.com/hashgraph/hedera-hcs-sxc.git
$ git remote -v

origin  https://github.com/$your_github_account/hedera-hcs-sxc.git (fetch)
origin  https://github.com/$your_github_account/hedera-hcs-sxc.git (push)
upstream        https://github.com/hashgraph/hedera-hcs-sxc.git (fetch)
upstream        https://github.com/hashgraph/hedera-hcs-sxc.git (push)
```
